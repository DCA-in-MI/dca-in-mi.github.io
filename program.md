...
| | **Interim Break** |
| 4:00 PM – 4:50 PM | **Paper Oral Presentations** <ul><li>Strategies to Improve Real-World Applicability of Laparoscopic Anatomy Segmentation Models</li><li>Repeat and Concatenate: 2D to 3D Image Translation with 3D to 3D Generative Modeling</li><li>Towards Establishing Dense Correspondence on Multiview Coronary Angiography: From Point-to-Point to Curve-to-Curve Query Matching</li><li>Discovering mechanisms underlying AI prediction of protected attributes via data auditing</li><li>ScribblePrompt: Fast and Flexible Interactive Segmentation for Any Biomedical Image</li><li>A Comparative Analysis of Implicit Augmentation Techniques for Breast Cancer Diagnosis Using Multiple Views</li><li>Advancing Brain Tumor Analysis: Curating a High-Quality MRI Dataset for Deep Learning-Based Molecular Marker Profiling</li><li>GSAM+Cutie: Text-Promptable Tool Mask Annotation for Endoscopic Video</li></ul>|
