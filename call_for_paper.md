...
- On the camera-ready paper submission site, what should I enter for the paper ID field?
  - The format of paper ID should be "DCAMI_[Your paper ID]". For example, "DCAMI_24". For our intents and purposes, the workshop ID equates the workshop acronym. We apologize for the ambiguous instructions on the submission site, and will be continue working with the CVPR chairs for clarification.
